...
<div class="greenCall ui-pag ui-body-c ui-page-header-fixed ui-page-active" id="" data-role="page" style="padding-top: 43px; min-height: 238px;">
  ...
  <span id="newposterr">${error}</span>
	...
	<jsp:include page="forms/create-post-lite.jsp"></jsp:include>
