...
<div data-role="page" data-ajax="false" id="" class="greenCall">
 ...
 <form:form data-ajax="false" method="POST" action="${pageContext.request.contextPath}/mw/proflite/update"  modelAttribute="profileUpdate" enctype="multipart/form-data">
