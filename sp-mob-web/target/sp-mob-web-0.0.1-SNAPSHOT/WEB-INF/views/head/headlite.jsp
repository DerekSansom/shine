...
<!--Js Custom Lib-->
<script src="${pageContext.request.contextPath}/static/js/js-calls.js" type="text/javascript"></script>
...
<script src="${pageContext.request.contextPath}/static/js/pageshow.js"></script>
