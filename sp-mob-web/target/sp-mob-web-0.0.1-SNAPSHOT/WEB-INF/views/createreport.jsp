...
<div data-role="page" id="" class="greenCall">
    <div data-role="header" data-position="fixed" class="greenohead">
	     ...
	     <![endif]-->
			<h1>Reason for reporting this post</h1>
			<a href="${pageContext.request.contextPath}/mw/notice?id=${reportForm.noticeId}" data-rel="back" data-theme="a">back</a>
  ...
  <div data-role="content">
	...
	<jsp:include page="forms/create-report.jsp"></jsp:include>
