...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
    	...
    	<form:form method="POST" action="${pageContext.request.contextPath}/mw/createboard" modelAttribute="createboard" id="frmcreateboard">
            ...
            <div class="loginStack">
            	<div class="areaField"><form:input path="createname" placeholder="Name"  /></div>
                <div class="areaField"><form:textarea path="landadrs"></form:textarea></div>
            ...
            <div class="greenOnBtn"><input type="button" name="preview" id="preview" value="Create Board" onClick="getPreview(this.form);"/></div>
