...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
      ...
      <ul class="termInset ui-listview ui-listview-inset ui-corner-all ui-shadow" data-inset="true" data-role="listview">
        <li class="ui-li ui-li-static ui-btn-up-c ui-corner-top ui-corner-bottom ui-li-last">
         <div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
          	<label for="postcat" class="ui-select">Category</label>
          	<div class="ui-sele">
          	...
          	<form:select path="catid" id="postcat">
      ...
      <div class="loginStack">
        <div class="areaField">
             <form:input path="title" placeholder="Title" id="txtposttitle" class="ui-input-text ui-body-c ui-corner-all ui-shadow-inset"/><form:errors path="title" element="span"  class="error"/>
        </div>
        <div class="areaField">
        ...
        <div class="areaToggle">
          <div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
          <label for="post-add-fb" id="post-add-fb-label" class="ui-slider">Add to Facebook</label>
      ...
      <ul class="termInset ui-listview ui-listview-inset ui-corner-all ui-shadow" data-inset="true" data-role="listview">
        <li class="ui-li ui-li-static ui-btn-up-c ui-corner-top ui-corner-bottom ui-li-last">
         <div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
         	<label for="expires" class="ui-select">Expires</label>
         	<div class="ui-selec">
	  ...
	  <ul class="inputFile ui-listview ui-listview-inset ui-corner-all ui-shadow" data-inset="true" data-role="listview">
        <li class="ui-li ui-li-static ui-btn-up-c ui-corner-top ui-corner-bottom ui-li-last">
          <div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
          <label for="file"><img height="76px" alt="image1" src="${pageContext.request.contextPath}/static/images/streetpin-logo-notext100.png" id="pimg"></label>
